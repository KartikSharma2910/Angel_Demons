...
export const contactData = [
  {
    ...
    subData: [
      ...
      },
      {
        ...
        text: "Multimedia and Design Software",
      },
      {
        label: "Corporate Office",
        text: "Cupertino, CA 95014,United States",
      },
      {
        label: "Target market",
        text: "B2B,B2C,B2B2C,Franchise",
      },
      {
      ...
      },
      {
        ...
        text: "Subscription,Freemium,Advertising,Pay Per Transaction",
      },
    ],
  },
];
